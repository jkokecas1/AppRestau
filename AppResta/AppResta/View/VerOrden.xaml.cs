    ...
    public partial class VerOrden : Rg.Plugins.Popup.Pages.PopupPage
    {
        ...
        private void Button_Terminar(object sender, EventArgs e)
        {
          ...
          //  Console.WriteLine("Platillos:" + bebidas +" = "+ bebidas2);
            ...
            {
                cadena0 = "http://192.168.1.112/resta/admin/mysql/Orden/index.php?op=updateOrden&estado=3" + "&fecha_inicio=" + h.Replace("/", "-").Replace(" ", "-") + "&fecha_estimada=" + h.Replace("/", "-").Replace(" ", "-") + "&idCart=" + ordenes.id+ "&empleado="+ idEmpleado;
                popAgregar(cadena0);
